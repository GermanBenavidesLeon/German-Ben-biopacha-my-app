...
const Productos = [
    {
        ...
        description: 'La nuez es el fruto del nogal, de forma redondeada u ovoide, con una cáscara dura y rugosa de color pardo rojiza. ... Además de ser uno de los frutos secos más apreciados por su agradable sabor, es uno de los más ricos en aceite por lo que se usan para su obtención.',
        price: 400, 
        imagen:'https://siemprejoven.es/Imagenes.ashx?FileName=/Imagenes/Contenidos/259/Cabecera/nueces-cerradas.jpg&xCrop=600&yCrop=349&xCoord=0&yCoord=36&xImage=600&yImage=421&xOrigCrop=688&yOrigCrop=400&Crop=true&Format=jpg'},
    ...
    {   id: 4, 
        name: 'Almendras', 
        categoria:'Frutos secos', 
        description: 'La almendra es la semilla comestible del fruto del almendro dulce, de color blanco brillante envuelta con una cubierta marrón rojiza.', 
        price: 500, 
        imagen:'https://static1.abc.es/media/bienestar/2020/09/30/almendras-ficha-k4CF--620x349@abc.jpg'},
    
    {   id: 5, 
        name: 'Pasas', 
        categoria:'Frutos secos', 
        description: 'Una pasa es una fruta seca obtenida del proceso de secado de una uva, con el objetivo de disminuir su humedad para lograr así su conservación por un periodo prolongado. ', 
        price: 300, 
        imagen:'https://cdn2.cocinadelirante.com/sites/default/files/styles/gallerie/public/images/2018/10/cuantos-gramos-de-pasas-de-uva-hay-que-comer-por-dia.jpg'},
